...
But recent downloads make my Git LFS bandwidth hit the limit.

So I moved the models to [Hugging Face](https://huggingface.co/YuC13600/coral_models).

Btw, I uploaded two new models, they look much better in N-Benchmark than the older ones. You can also check them on the same page on Hugging Face.

# (Legacy) dinov2_finetuned_models
...
| **20260306_233824**        | PML m=2        | ❌                 | whole image | <hr>             | 0.1604       | **81.1%**       | 81.2%           | 77.4%           | 85.2%           | 81.1%           | DINOv3 ViT-S+/16 (timm 512), ~2.0h |
| **20260308_110634 (Best)** | AreaAware 0.75 | AreaAware 0.75     | whole image | <hr>             | 0.1604       | **86.6%**       | 93.8%           | 80.6%           | 85.2%           | 86.5%           | DINOv2 ViT-B/14 (timm 518), ~7.2h  |
